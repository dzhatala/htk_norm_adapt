...
-S train_pca.lst  -H hmm0_$prefix/hmmdefs -M hmm1_$prefix phonems.lst"
echo $cmd ; eval $cmd
...
-S train_pca.lst  -H hmm1_$prefix/hmmdefs -M hmm2_$prefix phonems.lst"
echo $cmd ; eval $cmd

mkdir -p hmm3_$prefix
echo creating hmms in hmm3_$prefix ...
cmd="$HTKTOOLS_DIR/HERest -T 1 -L $labdir -C configtrain.txt  -t $prune_param \
-S train_pca.lst  -H hmm2_$prefix/hmmdefs -M hmm3_$prefix phonems.lst"
echo $cmd ; eval $cmd
...
cmd="$HTKTOOLS_DIR/HERest -T 1 -L $labdir -C configtrain.txt  -t $prune_param \
-S train_pca.lst  -H hmm5_$prefix/hmmdefs -M hmm6_$prefix monophones1"
echo $cmd ; eval $cmd
...
cmd="$HTKTOOLS_DIR/HERest -T 1 -L $labdir -C configtrain.txt  -t $prune_param \
-S train_pca.lst  -H hmm6_$prefix/hmmdefs -M hmm7_$prefix monophones1"
echo $cmd ; eval $cmd
