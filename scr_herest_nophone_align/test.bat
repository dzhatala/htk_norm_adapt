...
@rem for play set rep_length=-Z 7
@rem for recog. set rep_length=-Z 20
@rem fixed double silence detection?
set rep_length=-Z 15
set saveaudioout=-e
...
%X_DIR%\HVite_vs2008_repbuf.exe -T 1 -H zoel_hmm17\hmmdefs -l '*' ^
